...
| `pages` | `text[] DEFAULT '{}'` | Array de URLs das páginas do encarte |
| `active` | `boolean DEFAULT true` | — |
| `created_at` | `timestamptz` | — |
...
Visualizador de encartes em lightbox. Navegação com setas ← →, teclado (ArrowLeft/ArrowRight/Escape), contador de páginas, dots clicáveis.
